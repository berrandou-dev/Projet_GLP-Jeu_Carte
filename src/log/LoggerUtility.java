 ...
 * 
 * Même architecture que le projet tree_v3 :
 *   - "text" → log4j-text.properties → game-log.txt
 *   - "html" → log4j-html.properties → game-log.html
 */
public class LoggerUtility {
	...
	public static Logger getLogger(Class<?> logClass, String logFileType) {
		if (logFileType.equals("text")) {
			...
			throw new IllegalArgumentException("Unknown log file type : " + logFileType);
		}
