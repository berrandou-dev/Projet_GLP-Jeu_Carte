...
public class HardBot extends BotPlayer {
    ...
    public Combination choisirCombinaison(List<Card> hand, Combination last) {
        ...
        for (Combination c : jouables) {
            if (c.getType() == last.getType() && c.getType() != CombinationType.BOMB) {
